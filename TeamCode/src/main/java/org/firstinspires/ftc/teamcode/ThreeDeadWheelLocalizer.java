...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1228.5364662961485; // y position of the first parallel encoder (in tick units)
        public double par1YTicks =  1165.6573949616004; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 643.1741089594033; // x position of the perpendicular encoder (in tick units)
    }
